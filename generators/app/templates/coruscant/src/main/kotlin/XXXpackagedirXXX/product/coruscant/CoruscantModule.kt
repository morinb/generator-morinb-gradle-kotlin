package <%= package %>.product.coruscant
...
class CoruscantModule {
    ...
    init {
        ...
        CoruscantModule::class.java.getResourceAsStream("hello.txt").use { hello -> println(BufferedReader(InputStreamReader(hello)).readLine()) }
    }
